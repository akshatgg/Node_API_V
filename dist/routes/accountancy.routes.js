...
accountancyRouter.post('/accounts/update', verify_token_1.default, account_controller_1.default.createAccount);
accountancyRouter.post('/accounts/delete', verify_token_1.default, account_controller_1.default.deleteAccount);
