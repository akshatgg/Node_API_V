...
var PostOfficeController = /** @class */ (function () {
    function PostOfficeController() {
    }
    PostOfficeController.getPostData = function (pincode) {
    ...
    PostOfficeController.getPostOfficeByPincode = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var pincode, data, e_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
    ...
    return PostOfficeController;
}());
exports.default = PostOfficeController;
//# sourceMappingURL=postOffice.controller.js.map