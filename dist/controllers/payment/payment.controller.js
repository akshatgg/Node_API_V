...
var PaymentController = /** @class */ (function () {
    ...
    PaymentController.initiatePayment = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var data, validationError, paymentUrl, callUrl, formData, easeBuzzResponse, accessKey, url, e_1;
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (!easeBuzzResponse.status) {
                            return [2 /*return*/, res.status(403).json({ success: false, message: "Payment Gateway Error" })];
                        }
                        accessKey = easeBuzzResponse.data;
                        if (config_1.config.enable_iframe == 0) {
                            url = "".concat(paymentUrl, "pay/").concat(accessKey);
    ...
    PaymentController.payout = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        data = schemas_1.payoutSchema.parse(req.body);
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, res.status(200).json({ success: true, data: easeBuzzResponse.data })];
                    case 2: return [2 /*return*/, res.status(400).send({ success: false, message: "Environment not supported" })];
                    case 3:
                        e_2 = _a.sent();
                        console.log(e_2);
    ...
    PaymentController.refund = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        data = schemas_1.refundSchema.parse(req.body);
    ...
    PaymentController.transactionDate = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        data = schemas_1.transactionDateSchema.parse(req.body);
    ...
    PaymentController.transaction = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        data = schemas_1.transactionSchema.parse(req.body);
    ...
    PaymentController.response = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var data;
            return __generator(this, function (_a) {
                try {
                    ...
                    if ((0, utils_1.checkReverseHash)(data, config_1.config)) {
                        return [2 /*return*/, res.send(req.body)];
                    }
                    return [2 /*return*/, res.send('false, check the hash value ')];
                }
                catch (e) {
                    console.log(e);
