...
exports.RegisterStartupController = void 0;
var index_1 = require("../index");
var RegisterStartupController = /** @class */ (function () {
    function RegisterStartupController() {
    }
    ...
    RegisterStartupController.findAllStartup = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var AllStartup, error_2;
    ...
    RegisterStartupController.getById = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var id, Startup, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        id = req.params.id;
                        return [4 /*yield*/, index_1.prisma.registerStartup.findUnique({
    ...
    RegisterStartupController.delete = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var id, deletedStartup, error_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        id = req.params.id;
                        return [4 /*yield*/, index_1.prisma.registerStartup.delete({
                                where: { id: parseInt(id) },
                            })];
                    case 1:
    ...
    return RegisterStartupController;
}());
exports.RegisterStartupController = RegisterStartupController;
//# sourceMappingURL=registerStartup.controller.js.map