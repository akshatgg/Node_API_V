...
var ContactUsController = /** @class */ (function () {
    ...
    ContactUsController.contactUs = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var userId, _a, name, email, message, phoneNumber, existingUser, newContactUs, error_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 3, , 4]);
                        userId = req.user.id;
                        _a = req.body, name = _a.name, email = _a.email, message = _a.message, phoneNumber = _a.phoneNumber;
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, index_1.prisma.contactUs.create({
                                data: {
                                    name: name,
                                    email: email,
                                    message: message,
    ...
    ContactUsController.findAllContactUs = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var allContactUs, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, index_1.prisma.contactUs.findMany({})];
                    case 1:
                        allContactUs = _a.sent();
                        res.status(200).json({ success: true, allContactUs: allContactUs });
                        return [3 /*break*/, 3];
                    case 2:
                        error_2 = _a.sent();
    ...
    ContactUsController.getById = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        id = req.params.id;
                        return [4 /*yield*/, index_1.prisma.contactUs.findUnique({
    ...
    ContactUsController.delete = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var id, deletedContactUs, error_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        id = req.params.id;
                        return [4 /*yield*/, index_1.prisma.contactUs.delete({
                                where: { id: parseInt(id) },
                            })];
                    case 1:
                        deletedContactUs = _a.sent();
                        res.status(200).json({ success: true, deletedContactUs: deletedContactUs, message: "Contact us deleted sucessfully" });
                        return [3 /*break*/, 3];
                    case 2:
                        error_4 = _a.sent();
                        console.log(error_4);
